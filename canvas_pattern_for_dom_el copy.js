...
function set_canvas_element_stripe (elementId, stripeId, color, fillColor, fillOpacity, stripeColor) {
...
function set_canvas_element_fill_color (elementId, fillOpacity, color, fillColor) {
    var canvas = document.getElementById(elementId)
    const ctx = canvas.getContext('2d');
    ctx.save();
//     console.log(elementId, opacity, color);
    console.log(hexToRGB(fillColor, fillOpacity))
    ctx.fillStyle =  hexToRGB(fillColor, fillOpacity);
    ctx.strokeStyle = color;
    ctx.strokeRect(0, 0, canvas.width, canvas.height);
    ctx.fillRect(0, 0, canvas.width, canvas.height);
